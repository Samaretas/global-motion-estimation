...
# video_path = os.path.join("resources", "videos", "small_objects_in_motion.mp4")
# save_path = os.path.join("results", "small_objects_in_motion", "")

video_path = os.path.join("resources", "videos", "small_objects_in_motion2.mp4")
save_path = os.path.join("results", "small_objects_in_motion2", "")

video_path = os.path.join("resources", "videos", "no_object_in_motion.mp4")
save_path = os.path.join("results", "no_object_in_motion", "")

# video_path = os.path.join("resources", "videos", "big_object_in_motion.mp4")
# save_path = os.path.join("results", "big_object_in_motion", "")
