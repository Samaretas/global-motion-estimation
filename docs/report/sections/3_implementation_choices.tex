...
\red{Insert pseudocode of the implementation.}
...
\red{Pseudocode here? May be redundant. Would be clearer. Would buy space. Would steal space. This makes me doubt.}